...
static void (*Z_FreeInternal)(void*) = (void(*)(void*))0x806BB25; 0x806BB25 1.51, 1.1 0x8068224

static void* (*Hunk_AllocateTempMemoryHighInternal)(size_t) = (void*(*)(size_t))0x806C4B7; //1.51 0x806C4B7, 1.10x806823C
static void* (*Hunk_ReallocateTempMemory)(size_t) = (void*(*)(size_t))0x806C6D0; //1.51 0x806C6D0, 1.1 0x806859C
static void (*Hunk_FreeTempMemory)(void*) = (void(*)(void*))0x806C742; //1.51 0x806C742, 1.10x8068624
...
#define qboolean int //g++ complaining again
#define qtrue 1
#define qfalse 0
...
#if CODPATCH == 1
#define GENTITY_SIZE 788 //1.1 788
#else
#define GENTITY_SIZE 796
#endif
